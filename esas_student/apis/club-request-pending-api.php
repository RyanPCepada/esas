...
switch ($method) {
    case 'GET':
        ...
        // Prepare and execute the query to fetch pending requests for the specific student
        $stmt = $pdo->prepare('
        ...
        if ($result) {
            ...
            echo json_encode(['error' => 'No pending club requests found for this student']);
        }
        break;
