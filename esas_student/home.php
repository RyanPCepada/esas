            ...
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-end mb-3">
                    ...
                    <div id="dropdownMenu" class="dropdown mt-4">
                        <a href="../esas_student/ellipsis/student_profile.php?student_id=<?php echo $student_id; ?>&club_id=<?php echo urlencode($club_id); ?>&application_id=<?php echo urlencode($application_id); ?>">See Profile</a>
