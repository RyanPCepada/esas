                            ...
                            clubsContainer.innerHTML = response.map(club => `
                                <div class="col-md-4 card-container"> 
                                    ...
                                    <div class="card card-img-only">
                                        <a href="${tab === 'active' ? `/esas/esas_student/home.php?club_id=${club.club_id}` : `/esas/esas_student/application_details.php?club_id=${club.club_id}&club_name=${encodeURIComponent(club.clubName)}&status=${tab}&registration_id=${club.registration_id}`}" 
