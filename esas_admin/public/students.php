...
<div class="row card-row1 col-md-12 mb-1" style="border: 1px solid transparent; margin: 0;">
    ...
    <div class="mt-1 mb-3 clearfix text-end">
        <a href="../public/crud/students/student_create.php" class="btn btn-danger pull-right">
    ...
    <table class="table table-bordered table-striped" style="background-color: #f9f9f9;"> <!-- Lighter stripe style -->
        <thead>
            <tr>
                <th> <input id="studentSearch" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search"></th>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const totalRows = studentRows.length; // Total number of rows
