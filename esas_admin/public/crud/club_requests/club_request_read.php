                ...
                <div class="card">
                    ...
                    <div class="card-footer text-center">
                        ...
                        <?php elseif ($status === 'approved'): ?>
                            <a href="../../crud/club_requests/club_add_request.php?clubName=<?php echo urlencode($clubName); ?>&coverPhoto=<?php echo urlencode($coverPhoto); ?>&student_id=<?php echo urlencode($student_id); ?>&mission=<?php echo urlencode($mission); ?>&vision=<?php echo urlencode($vision); ?>"
