                ...
                <div class="row g-0">
                    ...
                    <div class="row g-0 p-2 justify-content-center">
                        ...
                        <div class="row main-page p-0">
                            ...
                            <div class="row trends-section col-md-3 m-0 p-0 pt-2 auto-scroll align-items-start justify-content-start" style="height: 770px; z-index: 2; position: relative;">
                        ...
                        <div class="row main-page mt-3 p-0">
                            ...
                            <?php include 'components/clubs_performance_race.php' ?>
                            ...
                            <div class="row trends-card-body">
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="row ml-1 mb-1">
                                        <div class="club-rating col-7" data-rating="${club.rating}" title="rating: ${club.rating}/5">
