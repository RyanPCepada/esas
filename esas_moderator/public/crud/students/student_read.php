            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="row" style="text-align: center; margin-top: 20px;">
                        <h5 class="modal-title m-2" id="generateIDModalLabel">Student Club ID</h5>
                        <button id="downloadPDF" class="btn btn-primary m-1" onclick="downloadPDF()">
                            <i class="fas fa-file-download"></i> <!-- Icon for Download -->
                        </button>
                        <button id="printID" class="btn btn-secondary m-1" onclick="printID()">
                            <i class="fas fa-print"></i> <!-- Icon for Print -->
                        </button>
                    </div>
                    <script>
